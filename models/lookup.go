...
type LookupOption struct {
	...
	Value    string `json:"value" sql:"value"`
	Label    string `json:"label" table:"translations" alias:"translations_label" sql:"value" on:"translations_label.structure_id = lookups_options.id and translations_label.structure_field = 'label'"`
	Active   bool   `json:"active" sql:"active"`
}
