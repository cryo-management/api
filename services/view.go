...
func CreateView(r *http.Request) *Response {
	...
	return create(r, &view, "CreateView", models.TableViews)
}
...
func LoadAllViews(r *http.Request) *Response {
	...
	return load(r, &views, "LoadAllViews", models.TableViews, condition)
}
...
func LoadView(r *http.Request) *Response {
	...
	return load(r, &view, "LoadView", models.TableViews, condition)
}
...
func UpdateView(r *http.Request) *Response {
	...
	return update(r, &view, "UpdateView", models.TableViews, condition)
}
...
func DeleteView(r *http.Request) *Response {
	...
	return remove(r, "DeleteView", models.TableViews, condition)
}
